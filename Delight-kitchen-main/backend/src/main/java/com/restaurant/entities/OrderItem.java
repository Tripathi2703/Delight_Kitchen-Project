...
public class OrderItem {
	...
	private FoodItems orderItemProduct;
	...
	public OrderItem(int orderItemId, int orderItemQuantity, float orderItemAmount,
			Orders orderItemOrder, FoodItems orderItemProduct) {
		super();
	...
	public FoodItems getOrderItemProduct() {
		return orderItemProduct;
	}

	public void setOrderItemProduct(FoodItems orderItemProduct) {
		this.orderItemProduct = orderItemProduct;
	}

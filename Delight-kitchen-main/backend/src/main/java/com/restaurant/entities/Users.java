...
public class Users {
	...
	private List<TablesBooking> tableList;
	...
	public Users(int userId, String name, String email, String phone, String password, String role,
			Date date, String currentStatus, List<TablesBooking> tableList) {
		super();
		this.userId = userId;
		this.name = name;
		this.email = email;
...
//	}
	...
	public List<TablesBooking> getTableList() {
		return tableList;
	}


	public void setTableList(List<TablesBooking> tableList) {
		this.tableList = tableList;
	}

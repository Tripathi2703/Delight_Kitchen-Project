...
@RestController
@CrossOrigin
public class FoodItemsControllerImpl {
	...
	@PostMapping("")
	public ResponseEntity<?> addProduct(@RequestBody FoodItemsDTO productDTO)
	{
	...
	@PutMapping("/{id}")
	public ResponseEntity<?> updateProduct(@RequestBody FoodItemsDTO productDTO, @PathVariable("id") int id)
	{
	...
	@PatchMapping("/{id}")
	public ResponseEntity<?> updateProductStatus(@RequestBody FoodItemsDTO productDTO, @PathVariable("id") int id)
	{

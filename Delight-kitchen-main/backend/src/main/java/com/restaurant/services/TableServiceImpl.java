...
public class TableServiceImpl {
	...
	List<TablesBooking> tables = tablesDao.findAll();
	
	for (TablesBooking table : tables) {
	...
	{
	List<TablesDTO> dtos = new ArrayList<TablesDTO>();
	List<TablesBooking> tables = tablesDao.findByTableStatus("Booked");
	...
	public Map<String, Object> addTable(TablesDTO tablesDTO) {
		...
		TablesBooking tables = tablesDao.save(entityConverter.toTablesEntity(tablesDTO));
	...
	public Map<String, Object> assignTableWaiter(int id, TablesDTO tablesDTO) {
		...
		TablesBooking tables = tablesDao.findByTableId(id);
	...
	{
	List<TablesDTO> dtos = new ArrayList<TablesDTO>();
	List<TablesBooking> tables = tablesDao.findByWaiter_UserId(id);

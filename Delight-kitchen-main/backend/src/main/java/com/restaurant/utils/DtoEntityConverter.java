...
public class DtoEntityConverter {
	...
	public FoodItems toProductEntity(FoodItemsDTO productDTO)
	{
		if(productDTO==null)
			return null;
		FoodItems product = new FoodItems();
	...
	public FoodItemsDTOSend toProductDTO(FoodItems product) {
		if(product == null)
			return null;
		FoodItemsDTOSend productDTOSend = new FoodItemsDTOSend();
	...
	public TablesDTO toTablesDTO(TablesBooking tables) {
		if(tables==null)
			return null;
	...
	public TablesBooking toTablesEntity(TablesDTO tablesDTO) {
		if(tablesDTO==null)
			return null;
		TablesBooking tables = new TablesBooking();
...
//		userDTO.setProfileImage(user.getProfileImage());
	...
	public Orders toOrderEntity(OrdersDTO ordersDTO)
	{
		...
		orders.setOrderTable(new TablesBooking(ordersDTO.getOrderTableId()));
	...
	public OrderItem toOrderItemEntity(OrderItemDTO orderItemDTO)
	{
		...
		orderItem.setOrderItemProduct(new FoodItems(orderItemDTO.getOrderItemProductId()));
